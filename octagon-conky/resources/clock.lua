...
function conky_draw_text()
    local group_angle = 0 -- Rotatiehoek voor de hele groep in graden
    local group_x = 210 -- X-coördinaat van het groepscentrum
    local group_y = 350 -- Y-coördinaat van het groepscentrum
    ...
    text_settings = {
        ...
        -- DATE
        {
            ...
            bold = false,
            x = 0, -- Relatief t.o.v. groepscentrum
            y = 20, -- Onder de groepscentrum
            colour = {{1, 0xFFA800, 0.85}},
        },
    }
