...
function conky_draw_weather()
    ...
    draw_text(cr, city, city_x, 220, city_font, city_size, city_color)
    ...
    draw_text(cr, weather_desc, desc_x, 260, desc_font, desc_size, desc_color)
